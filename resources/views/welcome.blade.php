    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item"><a href="{{ route('articals.index') }}" class="nav-link">Articles</a></li>
                ...
                <li class="nav-item"><a href="{{ route('login') }}" class=" ml-4 nav-link">Login</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="case" id="post">
                    <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-8 d-flex">
                            <a href="{{ route('posts.show',[$post->id]) }}" class="img w-100 mb-3 mb-md-0" style="background-image: url(images/{{ $post->image }});"></a>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-4 d-flex">
                            <div class="text w-100 pl-md-3">
                                <span class="subheading" style="color: black;">{{ $post->category->name }}</span>
